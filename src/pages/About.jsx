...
const About = () => {
  return (
    <div className="flex flex-col items-center gap-5 justify-center relative min-h-screen md:p-6 p-4 mb-4">
      <Animate>
      ...
      <div className="flex flex-col-reverse gap-8 md:mt-3 lg:flex-row items-center justify-center text-center md:px-8 w-full max-w-6xl">
        <div className="flex-1 px-4">
          <Animate>
            <p className="text-lg md:text-xl text-gray-200 leading-relaxed max-w-[700px] mx-auto">
